...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://www.bestebroker.be/belgie/meerwaardebelasting-2026-uitleg',
    locale: 'nl_BE',
    type: 'article',
  },
  alternates: { canonical: 'https://www.bestebroker.be/belgie/meerwaardebelasting-2026-uitleg' },
}
