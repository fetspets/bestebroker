...
const categories = [
  { id: 'beginners', label: '🌱 Voor beginners', ids: ['hangmatbelegger', 'psychology-of-money-nl', 'jong-beleggen'] },
  { id: 'etf', label: '📊 ETF-beleggen', ids: ['hangmatbelegger', 'beleggen-doe-je-zo'] },
  { id: 'mindset', label: '🧠 Mindset & gedrag', ids: ['psychology-of-money-nl', 'meer-geld-minder-stress'] },
  { id: 'gevorderd', label: '📈 Gevorderden', ids: ['intelligente-belegger', 'thomas-guenter', 'fire-charlotte-van-brabander'] },
